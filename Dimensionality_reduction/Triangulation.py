...
def convert2geo(contour,target_edge_length):
    filepath="D:\\Users\\papagian\\python\\Dimensionality_reduction\\gmsh\\"
...
def call_gmsh():
    ...
    try:
        ...
        subprocess.call([os.path.join(filepath,'gmsh.exe'),os.path.join(filepath,'contour.geo'),'-2','-algo','meshadapt','-o',os.path.join(filepath,'output.msh')])
...
def get_extrapoints_target_length(contour,target_edge_length):

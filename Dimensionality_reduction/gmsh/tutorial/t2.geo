...
//+
Recursive Delete {
  Line{1}; Line{2}; Line{3}; Line{4}; Line{5}; Line{113}; Line{117}; Line{116}; 
}
//+
Recursive Delete {
  Line{115}; 
...
Disk(2) = {0.1, 0.1, 0, 0.025, 0.025};
//+
SetFactory("Built-in");
//+
Extrude {0, 0, 3} {
  Surface{1}; Line{5}; Layers{5}; Recombine;
}
//+
Extrude {0, 0, 3} {
  Line{5}; Layers{5}; Recombine;
}
//+
Extrude {0, 0, 3} {
  Line{119}; Layers{5}; Recombine;
}
//+
Recursive Delete {
  Line{119}; 
